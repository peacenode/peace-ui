...
export function buildRegistryBase(config: DesignSystemConfig) {
  ...
  return {
    ...
    ...(config.rtl && {
      docs: `To learn how to set up the RTL provider and fonts for your app, see https://peace-ui.dev/docs/rtl/${config.template ?? "next"}`,
    }),
  }
}
