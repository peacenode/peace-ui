...
describe("peace-ui init - next-app", () => {
...
describe("peace-ui init - vite-app", () => {
...
describe("peace-ui init - custom style", async () => {
...
describe("peace-ui init - existing components.json", () => {
