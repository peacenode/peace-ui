...
const PEACE_UI_MCP_VERSION = "latest"
...
const CLIENTS = [
  {
    ...
    config: {
      mcpServers: {
        "peace-ui": {
          command: "npx",
          args: [`peace-ui@${PEACE_UI_MCP_VERSION}`, "mcp"],
        },
      },
    },
  },
  ...
  },
  {
    ...
    config: {
      ...
      mcp: {
        "peace-ui": {
          type: "local",
          command: ["npx", `peace-ui@${PEACE_UI_MCP_VERSION}`, "mcp"],
          enabled: true,
        },
      },
    },
...
const DEPENDENCIES = [`peace-ui@${PEACE_UI_MCP_VERSION}`]
  ...
  .action(async (opts, command) => {
    try {
      ...
      if (options.client === "codex") {
        ...
        logger.break()
        logger.log("To configure the peace-ui MCP server in Codex:")
        logger.break()
        logger.log(
        ...
        logger.log()
        logger.info(`[mcp_servers.peace-ui]
command = "npx"
args = ["peace-ui@${PEACE_UI_MCP_VERSION}", "mcp"]`)
        logger.break()
